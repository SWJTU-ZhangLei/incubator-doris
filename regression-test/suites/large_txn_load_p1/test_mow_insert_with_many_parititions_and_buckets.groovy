...
suite("test_mow_insert_with_many_parititions_and_buckets") {
    def tableName = 'test_mow_insert_with_many_parititions_and_buckets'
    ...
    // put_size=129259 del_size=1512069 num_put_keys=1502 num_del_keys=24001 txn_size=9202023 txn_id=2631453149184
    sql """ insert into ${tableName} values ${makeInsertStmt(0, 1500)};"""
    def result = sql """ select count(*) from ${tableName};"""
    assertEquals(6000, result[0][0])
    sql """ DROP TABLE IF EXISTS ${tableName} FORCE;"""
}
